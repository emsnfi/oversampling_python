# First feature selection (chi2) second: oversampling
...
def calculatethreemethod(train, test, id, path, approach, sheetName):
    ...
    for index in range(len(f)):
        ...
        print('into the file')
        wb = load_workbook(
            '/Users/emily/Desktop/Research/fs_ensemble/FS_ensemble.xlsx')
        ...
        '''
        wb.save('/Users/emily/Desktop/Research/fs_ensemble/FS_ensemble.xlsx')
...
print('fff', folderpath[14:])
folderpath = folderpath[14:]
folderpath = ['../data/all/kddcup-buffer_overflow_vs_back-5-fold']
